...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  primary:
    'bg-gradient-to-br from-[#6366F1] to-[#4F46E5] hover:from-[#818CF8] hover:to-[#6366F1] text-white shadow-[0_2px_12px_rgba(99,102,241,0.3)] border border-white/10 hover:border-white/20',
  ...
  danger: 'bg-gradient-to-br from-[#F43F5E] to-[#E11D48] hover:from-[#FB7185] hover:to-[#F43F5E] text-white shadow-[0_2px_12px_rgba(244,63,94,0.3)] border border-white/10 hover:border-white/20',
  success:
    'bg-gradient-to-br from-[#10B981] to-[#059669] hover:from-[#34D399] hover:to-[#10B981] text-white shadow-[0_2px_12px_rgba(16,185,129,0.3)] border border-white/10 hover:border-white/20',
};
